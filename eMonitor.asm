...
UARTD			EQU		10H				;Data address
UARTC			EQU		11H				;Control address
UARTS			EQU		11H				;Status address
...
PPIPA 			EQU 20H               ; 8255A PORT A
PPIPB 			EQU 21H               ; 8255A PORT B
PPIPC 			EQU 22H               ; 8255A PORT C
PPICTRL 		EQU 23H               ; 8255A CONTROL REGISTER
...
ROM 			EQU 0E000h          		  ; Debugger goes here
DRAM 			EQU 07800h         			  ; Debugger RAM (96 bytes required)
...
DSTACK 			EQU 	07800H          	; Debugger stack
;
...
TEST: 			CALL INIT               	; Set up hardware
				...
				DB 0Dh, 0Ah
				DB "CPU8085 Monitor Version 3.5.2"
				DB 0Dh, 0Ah
				DB "Modified by WOEPER 2025"
				DB 0Dh, 0Ah
				DB "Primary UART is "
				DB 0
				LHLD	SPDAMSG
...
;
INIT:			MVI		A,10000011B				; PPI PORTS  A AND C HIGH DEFINED AS OUTPUT B AND C LOW AS INPUT
